...
values 
  ('Apartment rent', 1200.00, 'USD', 'expense', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'month', current_date + interval '10 hours'),
  ('Electricity bill', 120.50, 'USD', 'expense', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'month', current_date + interval '17 days 8 hours'),
  ('Internet bill', 50.00, 'USD', 'expense', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'month', current_date + interval '1 days 9 hours'),
  ('Phone subscription', 60.00, 'EUR', 'expense', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'month', current_date + interval '11 hours'),
  ('Salary', 3500.00, 'USD', 'income', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'month', current_date + interval '10 hours'),
  ('Bonus', 500.00, 'USD', 'income', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'year', current_date + interval '4 days 14 hours'),
  ('Rental income', 2000.00, 'GBP', 'income', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'month', current_date + interval '2 days 12 hours'),
  ('Investment return', 1500.00, 'USD', 'income', '8d65ee5d-3897-4f61-b467-9bdc8df6f07f', 1, 'year', current_date + interval '10 days 10 hours');
-- with cte1 as (
--   select 
