...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors duration-100 focus:bg-light data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:shrink-0",
      inset && "pl-8",
      className
    )}
    {...props}
