...
![Person using the Telegram bot on their mobile phone](/blog/telegram-bot-integration/telegram.png "Telegram Bot")
...
1. **Text Entries**: Type details about your incomes or expenses in the chat, and the bot will automatically register them. For example: <span className="my-4 block"><Copyable content="I spent 50 PLN on shopping" /></span> The bot’s response will confirm that the expense has been logged to your account.
